...
from algorithm.a2c_operation import A2COperation
...
class A2COperationProtossExperiment(DistributedExperiment):
    def __init__(self):
        super().__init__()
    ...
    def run(self, global_args):
        ...
        config = Config(
            screen_features=[],
            minimap_features=[],
            available_actions=[PROTOSS_MACROS[0],PROTOSS_MACROS[1],PROTOSS_MACROS[2],PROTOSS_MACROS[3],
                               PROTOSS_MACROS[4], PROTOSS_MACROS[5], PROTOSS_MACROS[6], PROTOSS_MACROS[7],
                               PROTOSS_MACROS[9]],
...
Experiment.register(A2COperationProtossExperiment, "A2C operation training protoss")
