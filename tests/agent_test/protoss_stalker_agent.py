...
class ProtossStalkerAgent(ProtossBaseAgent):
    ...
    def step(self, obs):
        ...
        self.information.update(obs, 1)
        print(self.information.transform())
        ...
        if len(self.actions) == 0:
            ...
            if idle_workers > 0:
                ...
                print(PROTOSS_MACROS.Train_Probe, adapter.transform([TimestepWrapper(obs, self.information, True)],
                ...
                print(PROTOSS_MACROS.Train_Stalker, adapter.transform([TimestepWrapper(obs, self.information, True)],
                ...
                print(PROTOSS_MACROS.Collect_Gas, adapter.transform([TimestepWrapper(obs, self.information, True)],
                                                                    [PROTOSS_MACROS.Collect_Gas]))
                self.actions = PROTOSS_MACROS.Collect_Gas()
            elif self.can_build():
                if food < 4 and mineral > 100:
                    print(PROTOSS_MACROS.Build_Pylon, adapter.transform([TimestepWrapper(obs, self.information, True)],
                    ...
                    print(PROTOSS_MACROS.Build_Assimilator, adapter.transform([TimestepWrapper(obs, self.information, True)],
                    ...
                    print(PROTOSS_MACROS.Build_CyberneticsCore, adapter.transform([TimestepWrapper(obs, self.information, True)],
                    ...
                    print(PROTOSS_MACROS.Build_Gateway, adapter.transform([TimestepWrapper(obs, self.information, True)],
